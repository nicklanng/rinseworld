...
var _engine = __webpack_require__(331);
...
var _imageToHeightmap = __webpack_require__(337);

var _imageToHeightmap2 = _interopRequireDefault(_imageToHeightmap);

var _webVRButton = __webpack_require__(338);

var _webVRButton2 = _interopRequireDefault(_webVRButton);

var _Player = __webpack_require__(351);

var _Player2 = _interopRequireDefault(_Player);

var _DemoCube = __webpack_require__(339);

var _DemoCube2 = _interopRequireDefault(_DemoCube);

var _HexTerrain = __webpack_require__(340);

var _HexTerrain2 = _interopRequireDefault(_HexTerrain);

var _Clouds = __webpack_require__(341);

var _Clouds2 = _interopRequireDefault(_Clouds);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } /* globals THREE */

__webpack_require__(342)(THREE);

var onLoad = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var engine, demoCube, heightmapImage, heightmap, terrain, clouds, player;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            engine = new _engine2.default();

            engine.appendDomElements();
            engine.registerDomEvents();
            engine.start();

            demoCube = new _DemoCube2.default({ x: 0.5, y: 1.5, z: -1 }, 0.5);

            engine.registerComponent(demoCube);
            demoCube.setPosition(0, 10, 0);

            _context.next = 9;
            return (0, _image2.default)('img/heightmap.jpg');

          case 9:
            heightmapImage = _context.sent;
            heightmap = (0, _imageToHeightmap2.default)(heightmapImage);
            terrain = new _HexTerrain2.default(1024, 1024, 100, heightmap);

            engine.registerComponent(terrain);

            clouds = new _Clouds2.default(60, 10000);

            engine.registerComponent(clouds);

            player = new _Player2.default(engine.camera);

            engine.registerComponent(player);
            player.setPosition(0, 10, 0);

            (0, _webVRButton2.default)(engine);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* globals THREE Stats */

var _renderer = __webpack_require__(332);

var _renderer2 = _interopRequireDefault(_renderer);

var _camera = __webpack_require__(333);

var _camera2 = _interopRequireDefault(_camera);

var _controls = __webpack_require__(334);

var _controls2 = _interopRequireDefault(_controls);

var _vrEffect = __webpack_require__(335);
...
var Engine = function () {
  function Engine() {
    ...
    this.camera = (0, _camera2.default)();
    this.controls = (0, _controls2.default)(this.camera);
    this.effect = (0, _vrEffect2.default)(this.renderer);
  ...
  _createClass(Engine, [{
    key: 'appendDomElements',
    value: function appendDomElements() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                this.vrDisplay.requestAnimationFrame(function (timestamp) {
    ...
    value: function update(timestamp) {
      ...
      this.vrDisplay.requestAnimationFrame(function (timestamp) {
        return _this3.update(timestamp);
      });
    }
  }, {
    key: '_detectVRDisplay',
    value: function () {
      ...
      function _detectVRDisplay() {
        return _ref2.apply(this, arguments);
      }

      return _detectVRDisplay;
    }()
  }]);
...
exports.default = function () {
  return new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.1, 10000);
};
...
exports.default = function (renderer) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              return loader.load(url, resolve, function () {}, reject);
            }));
...
exports.default = function (engine) {
  var vrButton = new webvrui.EnterVRButton(engine.renderer.domElement, uiOptions);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* globals THREE */

var SPEED = 0.001;

var DemoCube = function (_Component) {
  _inherits(DemoCube, _Component);

  function DemoCube(position, size) {
    _classCallCheck(this, DemoCube);

    var _this = _possibleConstructorReturn(this, (DemoCube.__proto__ || Object.getPrototypeOf(DemoCube)).call(this));
...
var HexTerrain = function (_Component) {
  _inherits(HexTerrain, _Component);

  function HexTerrain(width, height, scale, heightmap) {
    _classCallCheck(this, HexTerrain);

    var _this = _possibleConstructorReturn(this, (HexTerrain.__proto__ || Object.getPrototypeOf(HexTerrain)).call(this));
  ...
  _createClass(HexTerrain, [{
    key: 'loadScene',
    value: function loadScene(scene) {
      var bufferedGeometry = new THREE.BufferGeometry();
      var vertices = this._buildVertices();
      var verts = new Float32Array(this._buildFaces(vertices));
      bufferedGeometry.addAttribute('position', new THREE.BufferAttribute(verts, 3));
      bufferedGeometry.computeVertexNormals();

      var darkGrayFlatMaterial = new THREE.MeshPhongMaterial({
        color: 0x222222,
        polygonOffset: true,
    ...
    key: '_buildVertices',
    value: function _buildVertices() {
      var deltaX = this.width / this.heightmap.length;
      var deltaY = this.height / this.heightmap[0].length;
    ...
    key: '_buildFaces',
    value: function _buildFaces(vertices) {
      var faces = [];

      for (var y = 0; y < this.heightmap[0].length - 1; y++) {
        for (var x = 0; x < this.heightmap.length - 1; x++) {
          var v1 = vertices[this.heightmap.length * y + x];
          var v2 = vertices[this.heightmap.length * y + x + 1];
          var v3 = vertices[this.heightmap.length * (y + 1) + x];
          var v4 = vertices[this.heightmap.length * (y + 1) + x + 1];

          if (y % 2 === 0) {
            faces.push(v1.x, v1.y, v1.z, v3.x, v3.y, v3.z, v2.x, v2.y, v2.z, v2.x, v2.y, v2.z, v3.x, v3.y, v3.z, v4.x, v4.y, v4.z);
          } else {
            faces.push(v1.x, v1.y, v1.z, v3.x, v3.y, v3.z, v4.x, v4.y, v4.z, v1.x, v1.y, v1.z, v4.x, v4.y, v4.z, v2.x, v2.y, v2.z);
          }
        }
      }
      return faces;
...
var Clouds = function (_Component) {
  _inherits(Clouds, _Component);

  function Clouds(clouds, width, height) {
...
module.exports = function( THREE ){
	...
	THREE.ShaderChunk[ 'begin_vertex' ] = 				__webpack_require__(345); 
	THREE.ShaderChunk[ 'color_fragment' ] = 			__webpack_require__(346);
	THREE.ShaderChunk[ 'color_pars_fragment.glsl' ] = 	__webpack_require__(347);
	THREE.ShaderChunk[ 'color_vertex.glsl' ] = 			__webpack_require__(348);
	THREE.ShaderChunk[ 'defaultnormal_vertex' ] = 		__webpack_require__(349);
	THREE.ShaderChunk[ 'uv_pars_vertex' ] = 			__webpack_require__(350);
